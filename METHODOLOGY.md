...
corresponding Gemma model itself**. `src/01_extract_activations.py` reproduces
that recipe exactly.
...
Both are computed from the **same saved vectors** — `src/03_refeature.py`
