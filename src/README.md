...
| # | script | does | GPU |
|---|---|---|---|
| 1 | `extract_activations.py` | builds the corpus: oasst1 + LMSYS prompts with responses generated by Gemma itself. **One activation per conversation** — see `--positions-per-doc` | yes |
